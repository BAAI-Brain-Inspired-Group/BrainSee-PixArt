    ...
    def __init__(
        ...
        **kwargs
        ...
        self.hyper_embeds = nn.ModuleList(
            [TokenEmbedderV2(embed_dim=1152, patch_size=2) for _ in range(6)]
        )
...
@MODELS.register_module()
def PixArtMS_XL_C(**kwargs):
    model = PixArtMS_C_Ext(depth=28, hidden_size=1152, patch_size=2, num_heads=16, **kwargs)
