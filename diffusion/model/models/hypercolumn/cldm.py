...
class HyperColumnLGN(nn.Module):
    def __init__(self,key=0,hypercond=[0],size=512,restore_ckpt = './hypercolumn/checkpoint/imagenet/equ_nv16_vl4_rn1_Bipolar_norm.pth',groups=[[0,1,4,8,9,15],[2,3],[5,12],[10],[6,7],[11,13,14],[5],[12],[2],[3]]):
        super().__init__()
        ...
        print('vector length:',self.lgn_ende.vector_length,', n_vector:',self.lgn_ende.n_vector)
