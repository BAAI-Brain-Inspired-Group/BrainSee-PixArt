...
def get_args():
    ...
    parser.add_argument('--txt_file', default='/share/project/gcw-data/code/pixart/asset/samples_2.txt', type=str)
    parser.add_argument('--model_path', 
                        default='/share/project/gcw-data/code/pixart/output/number/checkpoints/PixArt-XL-2-1024-MS.pth', type=str)
