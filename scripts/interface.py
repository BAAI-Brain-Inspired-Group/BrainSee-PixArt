...
def get_args():
    ...
    parser.add_argument('--model_path', default='/home/easytaker/code/generate/dit-base/PixArt-alpha/output/pretrained_models/PixArt-XL-2-256x256-MSCOCO-FID732.pth', type=str)
