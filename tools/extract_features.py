...
class DatasetMS(InternalData):
    def __init__(self, root, image_list_json=None, transform=None, resolution=1024, load_vae_feat=False, aspect_ratio_type=None, start_index=0, end_index=100000000, **kwargs):
        ...
        for json_file in image_list_json:
            meta_data = self.load_json('/home/easytaker/data/coc2017/sa/flat_captions_train2017.json')
...
def extract_caption_t5():
    ...
    t5 = T5Embedder(device="cuda", local_cache=True, cache_dir=f'/home/easytaker', model_max_length=120)
...
def extract_img_vae():
    vae = AutoencoderKL.from_pretrained(f'/home/easytaker/sd-vae-ft-ema').to(device)
...
def get_args():
    ...
    parser.add_argument("--img_size", default=1024, type=int, help="image scale for multi-scale feature extraction")
    parser.add_argument('--start_index', default=0, type=int)
    parser.add_argument('--end_index', default=1000000, type=int)
    
    parser.add_argument('--json_path', default='/home/easytaker/data/coc2017/sa/flat_captions_train2017.json',type=str)
    parser.add_argument('--t5_save_root', default='/home/easytaker/data/coc2017/sa/SA1B/caption_feature_wmask', type=str)
    parser.add_argument('--vae_save_root', default='/home/easytaker/data/coc2017/sa/coco_sa1b_style/img_vae_features_1024', type=str)
    parser.add_argument('--dataset_root', default='/share/project/data/COCO2017', type=str)
